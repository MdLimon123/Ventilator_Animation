...
import 'package:ventilator_animation/utils/dimension.dart';
import 'package:ventilator_animation/widgets/bat_shape.dart';
import 'package:ventilator_animation/widgets/button_fan.dart';
...
class _VentilatorScreenState extends State<VentilatorScreen> with SingleTickerProviderStateMixin{
    ...
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("An animated fan", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
          centerTitle: true,
        ...
        bottomNavigationBar: const Padding(
          ...
          child: Text("Powered By Md Limon Islam",style: TextStyle(color: Colors.white),
              ...
              Positioned(
                ...
                children: [
                  Container(
                    ...
                    width: Dimension.getScreenWidth(context) * 0.3,
                    alignment: Alignment.center,
  ...
  getAllBats(){
    return AnimatedBuilder(
        ...
        builder: (context, child){
          return Transform.rotate(angle: _controller.value * 2 * 3.14159,
          child: Container(
            height: 200,
            width: 200,
            alignment: Alignment.center,
            ...
            children: [
              ...
              inOn? GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Text('OFF', style: TextStyle(color: Colors.white, fontSize: 5),),
                ),
              ): GestureDetector(
                onTap: (){
                  setState(() {
